 ...
 *
 * Число изменений и количество элементов
 * невозможно учесть в одном переменной
 * private int sizeAndModCount = 0
 * Например, вы добавили элемент в коллекцию, а затем удалили.
 * Сколько элементов в коллекции? 0.
 * Сколько раз вы ее изменили? 2
 */
//////////////////////////////////////////////////////////
/**
